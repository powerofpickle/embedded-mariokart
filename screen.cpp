...
Screen::Screen(){
  ...
  */
  ...
  window = glfwCreateWindow(WIDTH*SCALE, HEIGHT*SCALE, "EE319K Game", NULL, NULL);
  if(!window){
    glfwTerminate();
    error = -1;
    return;
  ...
  //glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, WIDTH, HEIGHT, 0,  GL_RGB, GL_UNSIGNED_SHORT_5_6_5, tex_pixels);

}

void Screen::text(char* text){
