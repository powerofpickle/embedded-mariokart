...
int8_t map1_nodes[] = {
    8,  31,  11,  18,  25,  9,   39,  17,  42,  36,  59, 45,  77, 36,
    86, 17,  108, 13,  116, 28,  115, 51,  95,  61,  78, 64,  52, 68,
    53, 80,  73,  80,  97,  78,  116, 92,  114, 106, 95, 117, 68, 111,
    49, 101, 34,  104, 21,  112, 14,  111, 8,   100, 7,  63,  8,  33};

int8_t map2_nodes[] = {5,   38,  6,   16,  22,  6,   43, 6,   84, 6,   101, 7,
                       107, 20,  106, 33,  105, 41,  99, 44,  94, 41,  85,  31,
                       70,  29,  57,  29,  42,  30,  35, 47,  41, 57,  63,  57,
                       87,  60,  88,  82,  86,  105, 73, 114, 60, 119, 35,  120,
                       10,  113, 5,   100, 5,   70,  5,  39};
...
Map::Map(const uint8_t *tiles, uint8_t width, uint8_t height,
         int8_t *progress_nodes, uint8_t num_nodes, uint16_t sky_color,
         uint8_t bg_tile, uint8_t p1_x, uint8_t p1_y, uint8_t p2_x,
         uint8_t p2_y)
#ifdef HOST
...
Map *Map::current_map() { return Map::current; }
